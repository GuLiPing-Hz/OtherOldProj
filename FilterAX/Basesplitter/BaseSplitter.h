...
#include <list>
#include "../AudioSwitch/iUserInterface.h"

#define ALLOCATORBUFFERSIZE (1024*1024)
#define PREPOSARRAYSIZE 3
...
class CBaseSplitterOutputPin
    : public CSourceStream/*CBaseOutputPin*/
	//, protected CAMThread
    , public IDSMPropertyBagImpl
    , public IMediaSeeking
    , public IBitRateInfo
	, public IGSeekPosition
{
...
//     HRESULT Deliver(IMediaSample* pSample);
    ...
    // bitrate stats
protected:
	bool FindMyInterface(REFIID riid,void** ppObj,bool bDownStream);
	bool FindAudioDecInterface();
...
public:
    CBaseSplitterOutputPin(CAtlArray<CMediaType>& mts, LPCWSTR pName,
                           CSource* pFilter, //CCritSec* pLock,
						   HRESULT* phr,DWORD nTrackNum,CMediaType* pMT,
						   int nBuffers = 0,
                           int QueueMaxPackets = MAXPACKETS);
    CBaseSplitterOutputPin(LPCWSTR pName, CSource* pFilter,
                           /*CCritSec* pLock,*/ HRESULT* phr,DWORD nTrackNum,CMediaType* pMT,
                           int nBuffers = 0,
                           int QueueMaxPackets = MAXPACKETS);
...
public:
	__int64						m_prepos[PREPOSARRAYSIZE];
	__int64						m_curpos;//文件位置，索引值等等,表示位置的变量
	DWORD					m_nTrackNum;
	bool							m_bNeedCut;
	float							m_fCutPercent;
	eStreamType			m_eStreamType;
	bool							m_bSeeked;
	IAudioDecReset*	m_iADR;
};

typedef std::list<CBaseSplitterOutputPin*> LISTAUDIOOUTPIN;

class CBaseSplitterFilter
    : public CSource/*CBaseFilter*/
    //, public CCritSec
	//, protected CAMThread
    , public IDSMPropertyBagImpl
    ...
    , public IBufferInfo
{
	friend class CBaseSplitterInputPin;
...
public:
    ...
    //HRESULT AddOutputPin(DWORD TrackNum, CBaseSplitterOutputPin* pPin);
...
protected:
    ...
    virtual void DemuxSeek(REFERENCE_TIME rt,CBaseSplitterOutputPin* pOut,__int64* pInt64=NULL) = 0;
	virtual void DemuxOnlySeek(REFERENCE_TIME rt,CBaseSplitterOutputPin* pOut,__int64* pInt64=NULL)=0;
	virtual void DemuxBeginFlush();
	virtual void DemuxEndFlush();
	virtual REFERENCE_TIME getStartOffset(CBaseSplitterOutputPin* pOut) = 0;
	virtual bool isEof() = 0;
    //virtual bool DemuxLoop() = 0;
	virtual HRESULT DemuxNextPacket(REFERENCE_TIME rtStartOffset,CBaseSplitterOutputPin* pOut,__int64* pInt64=NULL,Packet* pPacket=NULL)=0;
...
public:
    CBaseSplitterFilter(TCHAR* pName, LPUNKNOWN pUnk, HRESULT* phr,
...
protected:
	...
	HRESULT DeliverPacket(Packet* p,REFERENCE_TIME rtOffset,CBaseSplitterOutputPin* pOut);
...
protected:
	...
	bool m_fAbort;
	LISTAUDIOOUTPIN m_listAudioOutput;
};
