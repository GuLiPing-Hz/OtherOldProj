...
public:
	...
	REFERENCE_TIME NextDTS(DWORD TrackNum,bool bReback=true,__int64* prePos = NULL);
    REFERENCE_TIME NextPTS(DWORD TrackNum,bool bReback=true,__int64* prePos = NULL);
    ...
    DWORD AddStream(WORD pid, BYTE pesid, BYTE ps1id, DWORD len,bool bTs=false);
