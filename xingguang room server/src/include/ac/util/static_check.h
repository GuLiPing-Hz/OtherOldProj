/* -*- C++ -*- */
//=============================================================================
// Õª×ÔLoki static_check.h
//=============================================================================

#ifndef AC_UTIL_STATIC_CHECK_INC_
#define AC_UTIL_STATIC_CHECK_INC_
...
#define AC_STATIC_CHECK(expr, msg) \
    { ac::CompileTimeError<((expr) != 0)> ERROR_##msg; (void)ERROR_##msg; } 
