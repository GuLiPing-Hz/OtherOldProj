...
////////////////////////////////////////////////////////////////////////////////
#ifndef AC_UTIL_SCOPEGUARD_INC_
#define AC_UTIL_SCOPEGUARD_INC_
...
#define AC_CONCATENATE_DIRECT(s1, s2)  s1##s2
#define AC_CONCATENATE(s1, s2)         AC_CONCATENATE_DIRECT(s1, s2)
#define AC_ANONYMOUS_VARIABLE(str)     AC_CONCATENATE(str, __LINE__)

#define AC_ON_BLOCK_EXIT(...)      ::ac::ScopeGuard AC_ANONYMOUS_VARIABLE(scopeGuard) = ::ac::MakeGuard(__VA_ARGS__); ((void)AC_ANONYMOUS_VARIABLE(scopeGuard))
#define AC_ON_BLOCK_EXIT_OBJ(...)  ::ac::ScopeGuard AC_ANONYMOUS_VARIABLE(scopeGuard) = ::ac::MakeObjGuard(__VA_ARGS__); ((void)AC_ANONYMOUS_VARIABLE(scopeGuard))
